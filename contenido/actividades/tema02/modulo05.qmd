...
description: "Se realiza una revisión de elementos fundamentales del Monitoreo y Evaluación de Programas de Fortificación de Alimentos así como cuatro indicadores propuestos por WFP-LACRO para este fin"
---

A continuación, pueden ver la presentación del módulo en formato vídeo sobre el tema propuesto.

{{< video https://youtu.be/rfLHIPV_mcM >}}
...
-   **Importancia** de los sistemas de **monitoreo**, **evaluación** y **aprendizaje**
...
# Importancia de los sistemas MEL
...
# El sistema de monitoreo, evaluación y aprendizaje propuesto por WFP-LACRO en detalle (basado en indicadores seleccionados)
...
En el [módulo 06](../../actividades/tema02/modulo06.qmd) nos adentraremos en detalles en la encuestas HCES, un elemento crítico para la calidad del proceso.

Puede realizar los ejercicio de este módulo en el siguiente enlace:

[Acceder al Ejercicio 5](../../ejercicios/tema01/ejercicio05.qmd)
...
2.  Fiedler JL, Smitz MF, Dupriez O, Friedman J. Household income and expenditure surveys: a tool for accelerating the development of evidence-based fortification programs. *Food Nutr Bull*. 2008;29(4):319-32.
