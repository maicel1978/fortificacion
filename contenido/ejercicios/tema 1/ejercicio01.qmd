---
title: "Micronutrientes y carencias nutricionales"
...
<label> <input type="radio" name="fortificacion" value="incorrecto"> Adición de vitaminas a alimentos para grupos específicos como niños o embarazadas </label><br>
<label> <input type="radio" name="fortificacion" value="correcto"> Incremento deliberado de micronutrientes esenciales en alimentos para mejorar la calidad nutricional con beneficio de salud pública </label><br>
<label> <input type="radio" name="fortificacion" value="incorrecto"> Adición de minerales solo a alimentos básicos como harinas o leche para consumo masivo </label><br>
